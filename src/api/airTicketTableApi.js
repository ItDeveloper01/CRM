...
export const TABLE_API_MAP = {
    1:{
        fetch : "/AirTicketMasterTable/GetAirlineTravelClassDTOTable",
        save : "/AirTicketMasterTable/SaveAirlineTravelClassDTOTable",
        title : "Travel class"
    },
    2:{
        fetch : "/AirTicketMasterTable/GetTicketTypeDTOTable",
        save : "/AirTicketMasterTable/SaveTicketTypeDTOTable",
        title : "Ticket Type"
    }
...
// ===========Fetch Table Api=====================
export const fetchAirTicketTableApi = async (token) => 
{
    const tableArray=[];
    debugger;
    try 
...
// =============Save Table========================
export const saveAirTicketTableApi = async (tableId, payload, token) => {
  try {
...
export const checkActiveAirTicketRecordsApi = async (tableId, rowId, token) => {
  try {
    debugger;
