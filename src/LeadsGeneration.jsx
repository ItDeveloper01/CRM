        ...
        <div className='border border-gray-300 bg-gray-50 rounded-lg p-4 mb-6'>
          ...
          <div className='flex gap-4 mb-4'>
            <div className='flex flex-col flex-1'>
              ...
              <input name='mobileNo' onChange={handleChange} value={leadObj.mobileNo || ''}
            ...
            <div className='flex flex-col flex-1'>
              ...
              <input name='emailId' type='email' onChange={handleChange} value={leadObj.emailId || ''} className={`border-highlight ${errors.emailId ? "border-red-500" : ""}`} />
